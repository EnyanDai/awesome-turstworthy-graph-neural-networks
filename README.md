...
3. **Adversarial Examples on Graph Data: Deep Insights into Attack and Defense.**
...
4. **Robustness of Graph Neural Networks at Scale.** NeurIPS 2021. [[paper]](https://www.in.tum.de/daml/robustness-of-gnns-at-scale/) [[code]](https://github.com/sigeisler/robustness_of_gnns_at_scale)
5. **Adversarial Attack on Large Scale Graph.** TKDE 2021. [[paper]](https://arxiv.org/pdf/2009.03488.pdf)
6. **Scalable Attack on Graph Data by Injecting Vicious Nodes.** arxiv 2020. [[paper]](https://arxiv.org/pdf/2004.14734.pdf)
7. **Graph Backdoor.**
  *Zhaohan Xi, Ren Pang, Shouling Ji, Ting Wang.* USENIX 2021. [[paper]](https://arxiv.org/abs/2006.11890)
8. **Backdoor Attacks to Graph Neural Networks.**
...
10. **Adversarial Attacks on Node Embeddings via Graph Poisoning.** 
...
11. **Adversarial Attack on Graph Structured Data.** [[paper]](https://arxiv.org/pdf/1806.02371.pdf) [[code]](https://github.com/Hanjun-Dai/graph_adversarial_attack)
...
13. **Attacking Graph Neural Networks at Scale.** 
...
15. **Adversarial Attacks on Graph Neural Networks via Meta Learning.**
...
17. **Attacking Graph Convolutional Networks via Rewiring.**
...
19. **Towards More Practical Adversarial Attacks on Graph Neural Networks.**
...
3. **Topology Attack and Defense for Graph Neural Networks: An Optimization Perspective.** 
   *Kaidi Xu, Hongge Chen, Sijia Liu, Pin-Yu Chen, Tsui-Wei Weng, Mingyi Hong, Xue Lin.* IJCAI 2019. [[paper]](https://arxiv.org/pdf/1906.04214.pdf) [[code]](https://github.com/KaidiXu/GCN_ADV_Train)
4. **Adversarial Attack on Graph Structured Data.** [[paper]](https://arxiv.org/pdf/1806.02371.pdf) [[code]](https://github.com/Hanjun-Dai/graph_adversarial_attack)
5. **Graph Adversarial Training: Dynamically Regularizing Based on Graph Structure**
   *Fuli Feng, Xiangnan He, Jie Tang, Tat-Seng Chua.*  TKDE 2019. [[paper]](https://arxiv.org/pdf/1902.08226.pdf)
6. **GraphDefense: Towards Robust Graph Convolutional Networks.**
   *Xiaoyun Wang, Xuanqing Liu, Cho-Jui Hsieh.*  arxiv 2019. [[paper]](https://arxiv.org/pdf/1911.04429v1.pdf)
7. **All You Need is Low (Rank): Defending Against Adversarial Attacks on Graphs.**
...
8. **GNNGuard: Defending Graph Neural Networks against Adversarial Attacks.** NeurIPS 2020. [[paper]](https://arxiv.org/abs/2006.08149)
9. **Node Similarity Preserving Graph Convolutional Networks.** WSDM 2021. [[paper]](https://arxiv.org/abs/2011.09643) [[code]](https://github.com/ChandlerBang/SimP-GCN)
10. **Robust Graph Neural Network Against Poisoning Attacks via Transfer Learning.**
...
12. **Adversarial Examples on Graph Data: Deep Insights into Attack and Defense.**
   *Huijun Wu, Chen Wang, Yuriy Tyshetskiy, Andrew Docherty, Kai Lu, Liming Zhu.*   IJCAI 2019. [[paper]](https://arxiv.org/pdf/1903.01610.pdf) [[code]](https://github.com/DSE-MSU/DeepRobust)
...
15. **Graph Structure Learning for Robust Graph Neural Networks.**
...
18. **Batch Virtual Adversarial Training for Graph Convolutional Networks.**
...
31. **Certifiable Robustness and Robust Training for Graph Convolutional Networks.**
